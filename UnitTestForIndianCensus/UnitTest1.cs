...
namespace UnitTestForIndianCensus
{
    ...
    public class UnitTest1
    {
        ...
        string stateCensusPath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\IndiaStateCensusData.csv";
        string wrongCensusPath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\IndiaStateData.csv";
        string wrongTypeStateCodePath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\IndiaStateCode.txt";
        string wrongHeaderStateCensusPath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\WrongIndiaStateCensusData.csv";
        string delimiterStateCensusPath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\DelimiterIndiaStateCensusData.csv";

        string stateCodePath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\IndianStateCode.csv";
        string wrongStateCodePath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\IndiaCode.csv";
        string wrongHeaderStateCodePath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\WrongIndiaStateCode.csv";
        string delimiterStateCodePath = @"C:\Users\admin1\Source\Repos\IndianCensusAnalyser\IndianCensusAnalyser\CSVFiles\DelimiterIndiaStateCode.csv";
